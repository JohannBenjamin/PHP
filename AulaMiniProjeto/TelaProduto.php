    ...
    <div class="row">
        ...
        <form action="" method="post" class="form-control">
            <div class="row mt-3">
                ...
                <div class="col-sm-3">
                    <button id="btnBuscar" name="btn" class="btn btn-primary" formaction="_sistema.php?tela=produto" value="buscar">&#128269;</button>
                </div>
                <div class="col-sm-3">
            ...
            <div class="col-sm-6">
                ...
                <div class="col-sm-6 text-end">
                    <button id="btnCadastrar" name="btn" class="btn btn-success" formaction="_sistema.php?tela=produto" value="cadastrar">Cadastrar</button>
                    <button id="btnAlterar" name="btn" class="btn btn-secondary" formaction="_sistema.php?tela=produto" value="alterar">Alterar</button>
                    <button id="btnLimpar" name="btn" class="btn btn-warning" formaction="_sistema.php?tela=produto" value="limpar">Limpar</button>
                    <button id="btnExcluir" name="btn" class="btn btn-danger" formaction="_sistema.php?tela=produto" value="excluir">Excluir</button>
